...
//! and ready to receive CPU01 to CPU02 IPC INT1 interrupts. It then blocks and waits
//! until IPC INT1 and IPC FLAG31 are available in the CPU02 boot ROM prior to
